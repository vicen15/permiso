...
import es.sgad.trama.permiso.service.incidencia.IncidenciaService;
...
public class ExistsIncidenciaMismasFechas implements org.jeasy.rules.api.Rule {
	...
	public boolean evaluate(Facts facts) {
	    ...
	    return nuevaSolicitudPermisoDTO.getListaSolicitudPermisoDetalle().stream()
	        .anyMatch(solicitudPermisoDetalleDTO -> incidenciaService.existenIncidenciasQueSeSolapenConNuevoPermiso(
	...
	public void execute(Facts facts) throws Exception {
		...
		errors.rejectValue("listaSolicitudPermisoDetalle",  Mensaje.SOLICITUD_INCIDENCIA_DETALLE_EXISTS.getCodigo(), "default No se pueden solicitar fechas previamente solicitadas");
	}
